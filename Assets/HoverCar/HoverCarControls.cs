...
public class HoverCarControls : MonoBehaviour {
	...
	private void FixedUpdate()
	{
		...
		m_rigidBody.AddRelativeForce(m_horizontalInput * Speed, 0f, m_verticalInput * Speed );
	...
	private void RotateCar(RaycastHit _hit)
	{
		...
		m_carMesh.localEulerAngles = Vector3.Lerp(new Vector3 (-m_verticalInput, 0, -m_horizontalInput), 
		                                          ...
		                                          new Vector3 (-m_verticalInput * m_rotationAngle, 0, -m_horizontalInput * m_rotationAngle), Time.deltaTime*30);
